...
Через правый клик по виджету или в `settings.json`:

| Параметр | По умолчанию | Описание |
|---|---|---|
| `DisplayStyle` | `0` | `0` = Иконка + процент (`🎧 85%`), `1` = Только иконка |
...
| `PollIntervalSeconds` | `15` | Интервал опроса устройств в секундах |

---

## Управление

- **Левый клик:** Открыть / закрыть детальное окно Flyout.
- **Правый клик:** Контекстное меню настроек (стиль отображения, автозапуск, обновление).
