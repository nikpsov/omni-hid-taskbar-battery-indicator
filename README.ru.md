...
> [!NOTE]
> **Экспериментальные профили и бейдж `Unverified`:**  
> Недавно добавленные или тестовые профили отображаются с золотистой плашкой **`Unverified`** в окне Flyout (и помечаются маркером `(unverified)` в контекстном меню). Это означает, что профиль устройства уже есть в каталоге, но ожидает подтверждения на физическом оборудовании.
> - **Устройство работает корректно?** Пожалуйста, создайте **[Issue на верификацию устройства](https://github.com/nikpsov/omni-hid/issues/new?template=verify_device.yml)** в основном [репозитории OmniHID](https://github.com/nikpsov/omni-hid) с подтверждением, что уровень заряда и статус работы/зарядки отображаются верно, чтобы мы перенесли модель в категорию проверенных!
> - **Устройство работает с ошибками или заряд неверный?** Пожалуйста, опишите проблему или приложите диагностический дамп в [OmniHID Issues](https://github.com/nikpsov/omni-hid/issues), и мы оперативно исправим профиль.
